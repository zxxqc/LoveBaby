...
import com.hb.lovebaby.adapter.SystemMessageAdapter;
...
public class SystemMessageActivity extends Activity {
	...
	private void initData() {
		tvTitle.setText(getString(R.string.system_message_title));
	...
	private void populateData() {
		for (int i = 0; i < 50; i++) {
			...
			SystemMessage m = new SystemMessage("","", "community", content,
					"11 min ago", "");
			list.add(m);
		}
	}
