...
import com.hb.lovebaby.adapter.PraiseMessageAdapter;
import com.hb.lovebaby.modle.BabyDynamicMessage;

public class PraiseMessageActivity extends Activity {
	...
	private void initData() {
		tvTitle.setText(getString(R.string.baby_dynamic_title));
		list = new ArrayList<BabyDynamicMessage>();
		populateData();
		adapter = new PraiseMessageAdapter(this, list);
